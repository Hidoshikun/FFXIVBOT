...
def QQCommand_fsx(*args, **kwargs):
    try:
        ...
        if '暴击' in s_msg:
            ...
            cd_15 = math.floor(math.floor(
                100 * 100 * (math.floor(1500 * (1000 - math.floor(130 * speed / nlv)) / 1000) / 1000)) / 100) / 100
            cd_20 = math.floor(math.floor(
                100 * 100 * (math.floor(2000 * (1000 - math.floor(130 * speed / nlv)) / 1000) / 1000)) / 100) / 100
            cd_25 = math.floor(math.floor(
                100 * 100 * (math.floor(2500 * (1000 - math.floor(130 * speed / nlv)) / 1000) / 1000)) / 100) / 100
            cd_30 = math.floor(math.floor(
                100 * 100 * (math.floor(3000 * (1000 - math.floor(130 * speed / nlv)) / 1000) / 1000)) / 100) / 100
            cd_80 = math.floor(math.floor(
                100 * 100 * (math.floor(8000 * (1000 - math.floor(130 * speed / nlv)) / 1000) / 1000)) / 100) / 100
            msg += '速度 {} 的计算结果(基数:380)：\nDoT收益:    {}\n复唱:    {}s\n1.5s:    {}s\n2.0s:    {}s\n3.0s:    {}s\n复活(8s):    {}s'.format(
                speed + 380, mult, cd_25, cd_15, cd_20, cd_30, cd_80)
        else:
